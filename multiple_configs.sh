...
python GraphlaxyDataGen.py optimization optimize -n grid4_v5 -g 4 &
python GraphlaxyDataGen.py optimization optimize -n grid6_v5 -g 6 &
python GraphlaxyDataGen.py optimization optimize -n grid8_v5 -g 8 &
...
wait
python GraphlaxyDataGen.py generate -f ../parameter_tunning_result_datasets/grid2_v5 -F -n grid2_v5 -s 1000 -m
python GraphlaxyDataGen.py optimization metrics -f ../parameter_tunning_result_datasets/grid2_v5 -m
python GraphlaxyDataGen.py statistics -f ../parameter_tunning_result_datasets/grid2_v5
